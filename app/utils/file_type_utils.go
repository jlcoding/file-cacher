...
func init() {
	...
	fileTypeMap.Store("48544d4c207b0d0a0942", "text/css")           //css
	fileTypeMap.Store("696b2e71623d696b2e71", "text/js")            //js
	...
	fileTypeMap.Store("3c3f786d6c2076657273", "application/xml")    //xml文件
	...
	fileTypeMap.Store("504b0304140006000800", "application/msword") //docx文件
